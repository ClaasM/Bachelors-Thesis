...
if __name__ == '__main__':
    # Create the config
    app.config.from_object('dashboard.server.settings')
    ...
    def basic_pages(*args, **kwargs):
        return make_response(open('./dashboard/client/index.html').read())
    ...
    import dashboard.server.auth as auth
    import dashboard.server.api as api
