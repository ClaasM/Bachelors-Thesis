...
% needed to be able to use URL cites
\usepackage{url}

% to make pretty timelines
\usepackage{chronology}

% to make pretty directory trees
\usepackage{forest}

% Set PDF minor version to 7 so that matplotlib pdf exports can be used
\pdfminorversion=7

\usepackage{amssymb}% http://ctan.org/pkg/amssymb
\usepackage{pifont}% http://ctan.org/pkg/pifont

% To be able to use degree sign
\usepackage{gensymb}

% Some definitions to make the directory tree look better
...
% This is used to create the right cross refs when placing figures in tables
\usepackage{capt-of}

\usepackage[nameinlink]{cleveref}      % 'nameinlink' option emulates look of \autoref

\newenvironment{absolutelynofuckingpagebreakyoubitch}
