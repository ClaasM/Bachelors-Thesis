...
semi-technical audience, as described in~\autoref{ch:goals},
...
as described in~\autoref{subsec:dataAtRest-DataInMotion},
...
as described in~\autoref{subsec:streaming},
...
\\
A settings-dialog is required to enable the user to choose between any of the streams explained in~\autoref{subsec:streaming},
...
the best model for sentiment analysis, developed in~\autoref{ch:sentimentAnalysis},
the best model for topic modeling, developed in~\autoref{ch:topicModeling},
and the combination of both, developed in~\autoref{ch:combiningSentimentAnalysisAndTopicModeling}
