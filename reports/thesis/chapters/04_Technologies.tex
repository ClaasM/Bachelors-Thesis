...
\cref{fig:kafka} shows a simplified, typical configuration of a messaging system powered by Kafka.
...
\cref{fig:spark} illustrates this architecture.
...
The previous examples~\cref{code:simpleParallelization} and~\cref{code:wordcount} exclusively used lambda expressions~\cite{pythonDocs},
...
%architecture diagram from the book?
