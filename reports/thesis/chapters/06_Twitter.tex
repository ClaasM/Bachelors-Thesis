...
% TODO maybe write about why we don't use the dataset supplied with the NLTK (no idea how they were selected, they don't seem random since they're very opinionated, no information on how they were labeled)
...
\begin{figure}
    ...
    \includegraphics[width=10cm]{../images/sanders_sentiment.png} % TODO turn into pdf
\end{figure}
...
\begin{figure}
    ...
    \includegraphics[width=10cm]{../images/wordloud_pre.png} % TODO turn into pdf
\end{figure}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        % TODO put this stopword list plus the code in the appendix and reference it here
    \end{enumerate}
\end{enumerate}
...
\begin{figure}
    ...
    \includegraphics[width=10cm]{../images/wordloud_post.png} % TODO turn into pdf
\end{figure}