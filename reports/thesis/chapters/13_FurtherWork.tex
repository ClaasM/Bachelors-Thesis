...
Due to the findings in~\ref{ch:dashboard}, % TODO more precise
...
% TODO we simplified by only looking at text with no special meaning to mentions, hashtags, etc. ~\ref{sec:twitter}