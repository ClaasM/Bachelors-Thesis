...
documents = [tweet['text'] for tweet in db.tweets.find()
             if 'lang' in tweet and tweet['lang'] == 'en'  # TODO or lang == und?
             ]

#  Filter non english documents TODO this is cool we should do this
...
# TODO 100 filters out too many
documents = [doc for doc in documents if len(doc) > 100]

print("We have " + str(len(documents)) + " documents longer than 100 characters ")
